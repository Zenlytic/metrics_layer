...
from granite.api.logging_utils import FORMAT, setup_logging

setup_logging()

logger = logging.getLogger("granite.api")
...
def create_app(config="granite.api.api_config.BaseConfig"):
    ...
    # Register blueprints
    import granite.api.blueprints as bp
