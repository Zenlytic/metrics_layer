...
def test_cumulative_query_metric_only_one(connection):
    ...
    correct = (
        ...
        "JOIN subquery_orders_total_lifetime_revenue ON subquery_orders_total_lifetime_revenue.order_date<=date_spine.date) "  # noqa
...
def test_cumulative_query_metric_with_number(connection):
    ...
    correct = (
        ...
        "order_date<=date_spine.date) ,base AS (SELECT (SUM(orders.revenue)) "
...
def test_cumulative_query_metric_only_two(connection, query_type):
    ...
    correct = (
        ...
        "JOIN subquery_orders_cumulative_customers ON subquery_orders_cumulative_customers.first_order_date<=date_spine.date) "  # noqa
        "SELECT (aggregated_orders_total_lifetime_revenue.orders_total_revenue) "
...
def test_cumulative_query_metrics_and_time(connection):
    ...
    correct = (
        ...
        "aggregated_orders_total_lifetime_revenue AS ("
        "SELECT SUM(orders_total_revenue) as orders_total_revenue,orders_order_date as orders_order_date "
        "FROM date_spine JOIN subquery_orders_total_lifetime_revenue "
        "ON subquery_orders_total_lifetime_revenue.order_date<=date_spine.date) ,"
...
def test_cumulative_query_metric_dimension_and_time(connection):
    ...
    correct = (
        ...
        "aggregated_orders_total_lifetime_revenue AS ("
        "SELECT SUM(orders_total_revenue) as orders_total_revenue,orders_new_vs_repeat "
        "as orders_new_vs_repeat,orders_order_date as orders_order_date FROM date_spine "
        "JOIN subquery_orders_total_lifetime_revenue ON subquery_orders_total_lifetime_revenue.order_date<=date_spine.date) "  # noqa
...
def test_cumulative_query_metrics_dimensions_and_time(connection):
    ...
    correct = (
        ...
        "orders_total_revenue,orders_new_vs_repeat as orders_new_vs_repeat,orders_order_date as "
        ...
        "as customers_number_of_customers,orders_new_vs_repeat as orders_new_vs_repeat,orders_order_date "
        "as orders_order_date FROM date_spine JOIN subquery_orders_cumulative_customers "
        "ON subquery_orders_cumulative_customers.first_order_date<=date_spine.date) "
