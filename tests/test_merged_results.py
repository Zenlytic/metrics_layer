...
def test_query_subquery_with_substring_in_name(connection):
    ...
    correct = (
        ...
        "aa_acquired_accounts_number_of_acquired_accounts DESC) SELECT "
...
def test_query_number_metric_with_non_matching_canon_dates(connection):
    ...
    correct = (
        ...
        "ORDER BY submitted_form_unique_users_form_submissions DESC) ,"
        ...
        "submitted_form.session_date) ORDER BY submitted_form_number_of_form_submissions DESC) "
