...
def test_simple_query():
    ...
    query = get_sql_query(metrics=["total_revenue"], dimensions=["channel"], project=project)
...
def test_simple_query_dimension_group(group: str):
    project = Project(models=[simple_model], views=[simple_view])
    query = get_sql_query(metrics=["total_revenue"], dimensions=[f"order_{group}"], project=project)
...
def test_simple_query_dimension_group_interval(interval: str):
    project = Project(models=[simple_model], views=[simple_view])
    query = get_sql_query(metrics=["total_revenue"], dimensions=[f"{interval}s_waiting"], project=project)
...
def test_simple_query_two_group_by():
    project = Project(models=[simple_model], views=[simple_view])
    query = get_sql_query(metrics=["total_revenue"], dimensions=["channel", "new_vs_repeat"], project=project)
...
def test_simple_query_custom_dimension():
    project = Project(models=[simple_model], views=[simple_view])
    query = get_sql_query(metrics=["total_revenue"], dimensions=["is_valid_order"], project=project)
...
def test_simple_query_custom_metric():
    project = Project(models=[simple_model], views=[simple_view])
    query = get_sql_query(metrics=["revenue_per_aov"], dimensions=["channel"], project=project)
