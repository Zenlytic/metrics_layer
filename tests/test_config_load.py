...
def test_config_load_yaml_model():
    model_path = os.path.join(BASE_PATH, "config/metrics_layer_config/data_model/model_with_all_fields.yml")
...
def test_config_load_yaml_view():
    view_path = os.path.join(BASE_PATH, "config/metrics_layer_config/data_model/view_with_all_fields.yml")
