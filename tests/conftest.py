...
quarterly_aggregates_view_path = os.path.join(
    BASE_PATH, "config/metrics_layer_config/views/quarterly_aggregates.yml"
)
...
view_paths = [
    ...
    quarterly_aggregates_view_path,
]
...
def seed_redshift_tables_data():
    order_records = [
        {"COMMENT": "I am an order id", "COLUMN_NAME": "ORDER_ID", "DATA_TYPE": "DOUBLE"},
        {"COMMENT": None, "COLUMN_NAME": "ORDER_CREATED_AT", "DATA_TYPE": "DATE"},
        {"COMMENT": None, "COLUMN_NAME": "REVENUE", "DATA_TYPE": "DOUBLE PRECISION"},
        {"COMMENT": None, "COLUMN_NAME": "ACQUISITION_DATE", "DATA_TYPE": "TIMESTAMPTZ"},
        {"COMMENT": None, "COLUMN_NAME": "ON_SOCIAL_NETWORK", "DATA_TYPE": "BOOLEAN"},
        {"COMMENT": None, "COLUMN_NAME": "CAMPAIGN", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "NEW_VS_REPEAT", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "PRODUCT", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "DAY_OF_WEEK", "DATA_TYPE": "CHAR"},
        {"COMMENT": None, "COLUMN_NAME": "TWITTER", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "EMAILS_FROM_US_IN_THE_LAST_WEEK", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "LAST_VIEWED_PAGE", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "CUSTOMER_ID", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "TOP_CUSTOMERS", "DATA_TYPE": "VARCHAR"},
    ]
    order_records = [{"TABLE_NAME": "ORDERS", **o} for o in order_records]
    session_records = [
        {"COMMENT": None, "COLUMN_NAME": "SESSION_ID", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "SESSION_DATE", "DATA_TYPE": "DATE"},
        {"COMMENT": None, "COLUMN_NAME": "ADD_TO_CART", "DATA_TYPE": "BIGINT"},
        {"COMMENT": None, "COLUMN_NAME": "CONVERSION", "DATA_TYPE": "REAL"},
        {"COMMENT": None, "COLUMN_NAME": "@CRoSSell P-roduct:", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "ACQUISITION_CHANNEL", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "SOCIAL_NETWORK", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "CAMPAIGN", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "NEW_VS_REPEAT", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "PRODUCT", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "DAY_OF_WEEK", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "TWITTER", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "EMAILS_FROM_US_IN_THE_LAST_WEEK", "DATA_TYPE": "VARCHAR"},
        {"COMMENT": None, "COLUMN_NAME": "LAST_VIEWED_PAGE", "DATA_TYPE": "VARCHAR"},
    ]
